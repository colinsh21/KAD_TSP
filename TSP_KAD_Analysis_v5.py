...
"""
v5: decision based on absolute threshold, not the difference between max and second.
"""

class TSP(object):
    def __init__(self, start=0, dissipation=.2, tolerance=.2, alpha=1.0, beta=1.0, explore=1.0, n_cities=4, force=None, damage_step=30):
        # inputs
    ...
    def design(self, g, tolerance):
        ...
        while True:
            ...
            elif (m_1) >= tolerance:  # prob gap is larger than tolerance
