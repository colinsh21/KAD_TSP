...
def KAD_analysis(t):
    results = {}
    norm=True
    analysis_type = ['out', 'close', 'between', 'in', 'hits-a', 'hits-h']
    ...
    for s, kad in t.history_k.iteritems():
        ...
        if s != 0:
            ...
            results['in'][s] = nx.in_degree_centrality(kad)
...
num_cities = 7
t, routes = run_ACO(steps=100, to_step_lim=True, cities=num_cities, explore=.2, tolerance=.9)
